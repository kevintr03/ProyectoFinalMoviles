  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Bubble(
          style: styleReceiver,
          child: const Text('hola', textAlign: TextAlign.right),
          showNip: true,
        ),
        Bubble(
          style: styleReceiver,
          child: const Text('Como estas', textAlign: TextAlign.right),
        ),
        Bubble(
          style: styleSender,
          child: const Text('bien kevin y tu'),
          showNip: true,
        ),
        Bubble(
          style: styleSender,
          child: const Text('ya sabes todo tranquilo'),
        ),
        // *********************
